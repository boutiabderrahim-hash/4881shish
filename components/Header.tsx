...
const Header: React.FC<HeaderProps> = ({ waiter, tableNumber, onLogout, onOpenDrawer, onNavigate, currentView, onEndShift, lowStockItems }) => {
  ...
  return (
    <header className="bg-gray-900 shadow-md p-2 flex items-center justify-between z-10">
      ...
      <div className="flex items-center space-x-4">
        <button onClick={onOpenDrawer} className="hidden md:block px-4 py-2 bg-yellow-500 text-white font-semibold rounded-md hover:bg-yellow-600">
          Abrir Caja
        </button>
