            ...
            <div className="bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg">
                ...
                <div className="p-6">
                    ...
                    <div className="bg-gray-900 p-4 rounded-lg text-center">
                        <p className="text-gray-400">Total Original: {formatCurrency(grossTotal)}</p>
                        <p className="text-lg text-red-400">Descuento: -{formatCurrency(calculatedDiscount)}</p>
                        <p className="text-xl font-bold text-green-400">Nuevo Total: {formatCurrency(grossTotal - calculatedDiscount)}</p>
                    </div>
                </div>
